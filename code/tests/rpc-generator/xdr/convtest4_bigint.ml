...
let test() =
  check id_b1 (`__1 "abc");
  check id_b1 (`_0);
  check id_b1 (`_1 [| Int32.of_int 5 |]);
  check id_b2 (`__1 "abc");
  check id_b2 (`_0);
  check id_b2 (`_1 [| Int32.of_int 5 |]);
  check id_b2 (`default(Int32.of_int 5, "opaque"));
  check id_b3 (`__1 "abc");
  check id_b3 (`_0);
  check id_b3 (`_1 [| Int32.of_int 5 |]);
  check id_b3 (`default(Int32.of_int 5));
  check id_b4 (`_2 "abc");
  check id_b4 (`_0);
  check id_b4 (`_1 [| Int32.of_int 5 |]);
  check id_b5 (`_2 "abc");
  check id_b5 (`_0);
  check id_b5 (`_1 [| Int32.of_int 5 |]);
  check id_b5 (`default(Int32.of_int 5, "opaque"));
  check id_b6 (`_2 "abc");
  check id_b6 (`_0);
  check id_b6 (`_1 [| Int32.of_int 5 |]);
  check id_b6 (`default(Int32.of_int 5));
  check id_b7 (`a "abc");
  check id_b7 (`b);
  check id_b8 (`a "abc");
  check id_b8 (`b);
  ...
  let x1 =
    ( (`__1 "abc"),
      ...
      (`_1 [| Int32.of_int 5 |]),
      (`_2 "abc"),
      (`default(Int32.of_int 5, "opaque")),
      (`default(Int32.of_int 5)),
      `b,
      (`c "opaque"),
      `c
    )
